...
import { filterByMedicalTopic } from './modules/keywordFilter.js';
import { pickHashtags } from './modules/hashtagger.js';
import type { RunSummary, MedArticle, TranslatedContent } from './types/index.js';
...
async function main(): Promise<void> {
  ...
  // 3. キーワードフィルタ
  const filtered = filterByMedicalTopic(
    allArticles,
...
function countBySource(articles: MedArticle[]): Record<string, number> {
